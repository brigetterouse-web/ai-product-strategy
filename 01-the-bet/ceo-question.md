# Artifact #0 — "What's our AI strategy?"

Three sentences. No polish. Private until M6, where the gap between this and your M6 answer is the proof you grew.

> **Overwrite this in your own words before class.** The exercise only works if it captures where *your* thinking actually is, unpolished, in your voice — a draft written by someone else defeats the point of re-reading it in Module 6. 60 seconds is enough.
...
**Re-read in M6.** Do not edit after today.
